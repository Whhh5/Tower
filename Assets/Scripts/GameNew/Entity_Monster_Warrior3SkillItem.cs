...
public class Entity_Monster_Warrior3SkillItemData : UnityObjectData
{
    public class ItemData
    {
        public float Angle = 0.0f;
    }
    public Entity_Monster_Warrior3SkillItemData() : base(0)
    {
    }
    public override EAssetKey AssetPrefabID => EAssetKey.Entity_Monster_Warrior3SkillItem;
    public override EWorldObjectType ObjectType => EWorldObjectType.Effect;
    private Entity_Monster_Warrior3SkillItem EntityTarget => GetCom<Entity_Monster_Warrior3SkillItem>();
...
public class Entity_Monster_Warrior3SkillItem : ObjectPoolBase
{
    private Entity_Monster_Warrior3SkillItemData EntityData => GetData<Entity_Monster_Warrior3SkillItemData>();
    [SerializeField]
