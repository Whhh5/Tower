...
using UnityEngine;
public class Entity_Gain_AddAttackRange1Data : EntityGainBaseData
{
    public override EGainType GainType => EGainType.AttackRange1;

    public override EBuffView GainView => EBuffView.perpetual;

    public override EAssetKey AssetPrefabID => EAssetKey.Entity_Gain_AddAttackRange1;
    private Entity_Gain_AddAttackRange1 EntityTarget => GetCom<Entity_Gain_AddAttackRange1>();

    private int m_AddAttackRange = 2;
    ...
    {
        m_Recipient.ChangeAttackRange(m_AddAttackRange);
...
public class Entity_Gain_AddAttackRange1 : EntityGainBase
{
    private Entity_Gain_AddAttackRange1Data EntityData => GetData<Entity_Gain_AddAttackRange1Data>();
    [SerializeField]
