...
public class Entity_Monster_WarriorBaseData : Entity_MonsterBaseNewData
{
    public override EAssetKey AssetPrefabID => EAssetKey.Entity_Monster_Warrior1;
    public override int AtkRangeBase => 1;
    public new Entity_Monster_MarriorBase EntityTarget => GetCom<Entity_Monster_MarriorBase>();
    public override async void AttackBehavior()
    {
        ...
        GTools.AudioMgr.PlayAudio(EAudioType.Monster_Warrior1_Attack1);
        await DOTween.To(() => 0.0f, value =>
        {
            ...
            else
            {
                if (!isArrive)
                {
                    ...
                    isArrive = true;
                    this.EntityDamage(m_CurAttackTarget, null, IsSkill ? AtkAddMagic : -1);
                    GTools.AudioMgr.PlayAudio(EAudioType.Monster_Warrior1_Attack2);
                }
