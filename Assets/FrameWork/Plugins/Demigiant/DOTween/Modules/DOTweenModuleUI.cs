...
namespace DG.Tweening
{
	public static class DOTweenModuleUI
    {
        ...
        public static TweenerCore<string, string, StringOptions> DOTextMeshProUGUI(this TextMeshProUGUI target, string endValue, float duration, bool richTextEnabled = true, ScrambleMode scrambleMode = ScrambleMode.None, string scrambleChars = null)
        {
            if (endValue == null)
            {
                if (Debugger.logPriority > 0) Debugger.LogWarning("You can't pass a NULL string to DOText: an empty string will be used instead to avoid errors");
